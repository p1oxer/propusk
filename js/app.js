(() => {
    ...
    function initSliders() {
        if (document.querySelector(".services-page__slider")) new core(".services-page__slider", {
            ...
            navigation: {
                prevEl: ".services-page__swiper-button-prev",
                nextEl: ".services-page__swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".content-partnership__slider")) new core(".content-partnership__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        if (document.querySelector(".control-page__slider")) new core(".control-page__slider", {
            ...
            pagination: {
                el: ".control-page-swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".control-page__slider-button-prev",
                nextEl: ".control-page__slider-button-next"
            },
            breakpoints: {
                320: {
                    coverflowEffect: {
    ...
    da.init();
    const contactsInput = document.querySelectorAll(".form-contacts__input");
    function inputFocus(event) {
        event.target.closest("div").querySelector(".form-contacts__input-placeholder").classList.add("_hidden");
    }
    function inputBlur(event) {
        if ("" != event.target.value) return;
        event.target.closest("div").querySelector(".form-contacts__input-placeholder").classList.remove("_hidden");
    }
    contactsInput.forEach((contactsInput => {
        contactsInput.addEventListener("focus", inputFocus);
    }));
    contactsInput.forEach((contactsInput => {
        contactsInput.addEventListener("blur", inputBlur);
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
